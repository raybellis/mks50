...
X247B:	MOV	R0,#0
	...
	SJMP	X249C
;
; ## DATA TABLE (10 values) ##
;
X2492:
	DB	0E0H,000H,0E7H,0C0H,0F0H
	DB	000H,0F5H,040H,0FEH,090H
;
...
X29F1:
	...
	DB	35H,(X2390 - X235F)
;
; 13 pairs of (values for R1, offset from X2278)
;
X2A39:
	DB	62H,(X2278 - X2278)			; 00H
	DB	63H,(X22DB - X2278)			; 63H
	DB	64H,(X22EE - X2278)			; 76H
	DB	65H,(X2289 - X2278)			; 11H
	DB	00H,(X22AC - X2278)			; 34H
	DB	66H,(X2289 - X2278)			; 11H
	DB	67H,(X228C - X2278)			; 14H
	DB	68H,(X2289 - X2278)			; 11H
	DB	69H,(X2299 - X2278)			; 21H
	DB	22H,(X22A5 - X2278)			; 2DH
	DB	6AH,(X22BB - X2278)			; 43H
	DB	6AH,(X22CE - X2278)			; 56H
	DB	24H,(X2301 - X2278)			; 89H
;
; 13 pairs of (values for R1, offset from X23D8)
;
X2A53:	
	DB	62H,(X23D8 - X23D8)			; 00H
	DB	63H,(X23DD - X23D8)			; 05H
	DB	64H,(X23DD - X23D8)			; 05H
	DB	65H,(X23D8 - X23D8)			; 00H
	DB	00H,(X23E2 - X23D8)			; 0AH
	DB	66H,(X23D8 - X23D8)			; 00H
	DB	67H,(X23D8 - X23D8)			; 00H
	DB	68H,(X23D8 - X23D8)			; 00H
	DB	69H,(X23D8 - X23D8)			; 00H
	DB	22H,(X23D8 - X23D8)			; 00H
	DB	6AH,(X23E9 - X23D8)			; 11H
...
;
; 36 pairs of (values for R1, offset from X188C)
;
X2AB5:	
	DB	031H,(X18B6 - X188C)			; 2AH
	DB	0B6H,(X188C - X188C)			; 00H
	DB	0B7H,(X188C - X188C)			; 00H
	DB	02FH,(X18B6 - X188C)			; 2AH
	DB	033H,(X188C - X188C)			; 00H
	DB	035H,(X18ED - X188C)			; 61H
	DB	030H,(X18A0 - X188C)			; 14H
	DB	030H,(X18D5 - X188C)			; 49H
	DB	030H,(X18DE - X188C)			; 52H
	DB	031H,(X18A9 - X188C)			; 1DH
	DB	031H,(X18A0 - X188C)			; 14H
	DB	0B8H,(X188C - X188C)			; 00H
	DB	0B9H,(X188C - X188C)			; 00H
	DB	031H,(X18C8 - X188C)			; 3CH
	DB	0BAH,(X188C - X188C)			; 00H
	DB	0BBH,(X188C - X188C)			; 00H
	DB	0BCH,(X188C - X188C)			; 00H
	DB	02FH,(X18A9 - X188C)			; 1DH
	DB	0BDH,(X188C - X188C)			; 00H
	DB	033H,(X1897 - X188C)			; 0BH
	DB	034H,(X188C - X188C)			; 00H
	DB	0BEH,(X188C - X188C)			; 00H
	DB	02FH,(X18A0 - X188C)			; 14H
	DB	034H,(X1897 - X188C)			; 0BH
	DB	02FH,(X190E - X188C)			; 82H
	DB	0B2H,(X188C - X188C)			; 00H
	DB	0BFH,(X188C - X188C)			; 00H
	DB	0C0H,(X188C - X188C)			; 00H
	DB	0C1H,(X188C - X188C)			; 00H
	DB	0C2H,(X188C - X188C)			; 00H
	DB	0C3H,(X188C - X188C)			; 00H
	DB	0C4H,(X188C - X188C)			; 00H
	DB	0C5H,(X188C - X188C)			; 00H
	DB	0C6H,(X188C - X188C)			; 00H
...
X2AFD:
	...
	DB	66H,(X1A9C - X1A6C)			; 30H
	DB	00H,(X1AAF - X1A6C)			; 43H
	DB	65H,(X1A9C - X1A6C)			; 30H
	DB	67H,(X1ABB - X1A6C)			; 4FH
	DB	69H,(X1AD5 - X1A6C)			; 69H
	DB	63H,(X1A6C - X1A6C)			; 00H
	DB	64H,(X1A84 - X1A6C)			; 18H
	DB	22H,(X1AEF - X1A6C)			; 83H
...
MIDIvelChgStr:
	DB	'MIDI velchg =   '
;
; takes table from X2F65 and returns (R4, A) indexed by R5
;
X2F5B:
	MOV	A,R5
	ADD	A,#6
	...
	RET
;
; # table accessed by routine above (109 pairs of values)
;
X2F65:
	DW	0007FH,00086H,0008EH,00097H,000A0H,000AAH,000B4H,000BFH
	DW	000CAH,000D6H,000E3H,000F1H,000FFH,0010EH,0011EH,0012FH
	DW	00141H,00155H,00169H,0017FH,00196H,001AEH,001C8H,001E3H
	DW	001FFH,0021DH,0023DH,00260H,00284H,002AAH,002D3H,002FEH
	DW	0032BH,0035BH,0038EH,003C5H,003FEH,0043BH,0047BH,004BFH
	DW	00508H,00554H,005A5H,005FBH,00656H,006B7H,0071DH,00789H
	DW	007FCH,00875H,008F6H,0097FH,00A0FH,00AA8H,00B4BH,00BF6H
	DW	00CACH,00D6DH,00E3AH,00F12H,00FF8H,010EBH,011EDH,012FDH
	DW	0141EH,01551H,01695H,017EDH,01959H,01ADBH,01C74H,01E25H
	DW	01FF0H,021D6H,023D9H,025FBH,0283DH,02AA2H,02D2BH,02FDAH
	DW	032B2H,035B6H,038E8H,03C4AH,03FE0H,043ACH,047B2H,04BF6H
	DW	0507AH,05543H,05A55H,05FB4H,06565H,06B6DH,071D0H,07894H
	DW	07FC0H,08759H,08F65H,097ECH,0A0F4H,0AA87H,0B4AAH,0BF69H
	DW	0CACAH,0D6D9H,0E3A0H,0F129H,0FF80H
;
